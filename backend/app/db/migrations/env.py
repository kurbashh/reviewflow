...
# --------------------------------------------------------------------------
# Импорт Base и ВСЕХ моделей проекта.
# Импорт models обязателен ДО обращения к Base.metadata — иначе таблицы
# не зарегистрируются в metadata и autogenerate молча сгенерирует пустую
# миграцию без единой операции.
# --------------------------------------------------------------------------
from app.config import settings
from app.db.base import Base
from app.db import models  # noqa: F401  регистрирует все таблицы в Base.metadata
...
# для сравнения текущего состояния БД со схемой, описанной в app/db/models.py.
