...
const API_BASE = `${import.meta.env.VITE_API_BASE_URL || "http://167-233-118-175.sslip.io"}/api/dashboard`;
const REDIRECT_BASE = `${import.meta.env.VITE_API_BASE_URL || "http://167-233-118-175.sslip.io"}/api/redirect`;
