                        ...
                        <div key={loc.id} className="rounded-2xl border border-slate-100 p-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between hover:bg-slate-50/20 transition-colors">
                          <div className="space-y-1">
                            ...
                            <p className="text-xs text-slate-400 font-mono">
                              Редирект: <a href={`http://localhost:8000/api/redirect/${loc.redirect_slug}`} target="_blank" rel="noopener noreferrer" className="text-brand hover:underline">/go/{loc.redirect_slug}</a>
                            </p>
                ...
                <CardShell>
                  ...
                  <form onSubmit={handleSaveLocation} className="mt-6 space-y-4">
                    ...
                    <div className="space-y-1">
                      ...
                      />
                      {!editingLocId && (
                        <p className="text-[10px] text-slate-400">Будет создана ссылка: <b>http://localhost:8000/api/redirect/{newLocSlug || "слаг"}</b></p>
                      )}
                    </div>
